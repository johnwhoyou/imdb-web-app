          ...
          <div className="w-3/4 lg:w-1/2 mx-auto bg-white z-10 bg-opacity-90 rounded-xl p-10 overflow-auto relative">
              ...
              <div className="absolute top-0 right-0 bg-black bg-opacity-50 w-full h-full z-10 pt-36">
                <div className="bg-white w-3/4 h-fit mx-auto rounded-xl p-5">
                  ...
                  <p className="text-center">
                    Are you sure you want to delete movie entry &apos;{name}&apos;?
                  </p>
                  ...
                  <div className="flex w-full gap-5">
                    <button
                      className={`${montserrat.className} mx-auto flex w-full gap-3 sm:w-1/2 md:w-2/5 px-5 py-2 text-[16px] text-white bg-gray-800 hover:brightness-75 ml-auto rounded-[20px] `}
                    ...
                    <button
                      className={`${montserrat.className} mx-auto flex w-full sm:w-1/2 md:w-2/5 px-5 py-2 text-[16px] text-white bg-red-500 hover:brightness-75 rounded-[20px] `}
                      onClick={() => deleteEntry()}
                    >
            ...
            >
              ...
              <input
                ...
                name="title"
                id=""
                className={`${montserrat.className} mb-10 border border-black border-opacity-30 w-full sm:w-2/3 py-2 px-5 shadow-md  rounded-lg text-[16px] hover:transition hover:border-opacity-80 duration-500 focus:outline-gray-500`}
              ...
              <div className="flex flex-col gap-0 md:flex-row md:gap-10 mb-5 w-full">
                <section className="flex flex-col w-1/2">
                  ...
                  <input
                    ...
                    name="year"
                    id=""
                    className={`${montserrat.className} sm:w-3/4 mb-5 border border-black border-opacity-30 py-2 px-5 shadow-md rounded-lg text-[16px] hover:transition hover:border-opacity-80 duration-500 focus:outline-gray-500`}
                    placeholder="Year..."
              ...
              <div className="flex flex-col gap-0 md:flex-row md:gap-10 mb-5">
                ...
                <section className="flex flex-col w-full">
                  ...
                  <input
                    ...
                    name="directors"
                    id=""
                    className={`${montserrat.className} sm:w-full mb-5 border border-black border-opacity-30 py-2 px-5 shadow-md  rounded-lg text-[16px] hover:transition hover:border-opacity-80 duration-500 focus:outline-gray-500`}
            ...
            <div className="flex w-full gap-5">
              <button
                className={`${montserrat.className} flex w-full gap-3 sm:w-1/2 md:w-fit px-5 py-2 text-[16px] text-white bg-red-400 hover:brightness-75 ml-auto rounded-[20px] `}
              ...
              <button
                className={`${montserrat.className} flex w-full sm:w-1/2 md:w-1/4 px-5 py-2 text-[16px] text-white bg-green-600 hover:brightness-75 rounded-[20px] `}
                onClick={() => saveEdits()}
              >
